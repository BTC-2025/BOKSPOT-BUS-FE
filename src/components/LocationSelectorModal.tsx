                ...
                <div className="space-y-6">
                  ...
                  {Object.keys(groupedCities).length === 0 && (
                    <div className="flex flex-col items-center justify-center py-8">
                      <p className="text-center text-slate-500 text-sm mb-4">No predefined cities found matching "{searchQuery}"</p>
                      <button
                        onClick={() => handleCitySelect(searchQuery)}
                        className="px-6 py-2 bg-[#8b6508] text-white font-bold rounded-xl shadow-lg hover:opacity-90 transition-opacity"
                      >
